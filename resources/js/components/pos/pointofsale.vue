            ...
            <div class="col-xl-5 col-lg-5">
             ...
             <a class="btn btn-info" href="">Add Customer</a>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="cart in carts" :key="cart.id">
                        <td>{{cart.pro_name}}</td>
                        <td><input type="text" readonly="" style="width:25px;" :value="cart.pro_quantity">
                ...
                <div class="card-footer">
                    ...
                    <select class="form-control" name="" id="" v-model="customer_id">
                    ...
                    <select class="form-control" name="" id="" v-model="payby">
