...
<body id="page-top">
    {{-- below app id div cotent or include all code for vue and its include after body tag and end of body tag  --}}
    <div id="app">
    <div id="wrapper">
    <!-- Sidebar -->
...
{{-- stock --}}
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        {{-- router-view work just like as yield ((router-view use in vue for dayanamic part but yield use in laravel)) --}}
